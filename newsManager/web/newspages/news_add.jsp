    ...
    <div class="row">
        <div class="jumbotron">
            <div class="container" style="width: 400px">
                ...
                <form id="from" action="${pageContext.request.contextPath}/newsAddServlet" method="post"
                      class="center-block">
                    <table border="1" class="table table-bordered table-hover ">
                        <div class="row form-group">
                            ...
                            <select class="form-control" name="topic" id="topic">
                                ...
                                <c:forEach items="${topics}" var="topic">
                                    <option class="form-group" value="${topic.topicname}">${topic.topicname}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="row form-group">
                        ...
                        <div class="row form-group">
                            ...
                            <input type="text" class="form-control" style=" height :25px;width: 300px" id="author"
                                   name="author" placeholder="请输入作者"/>
                        </div>
                        <div class="row form-group">
                            <label for="summary">摘要：</label>
                            <textarea id="summary" cols="60" rows="4" name="summary" placeholder="请输入摘要"></textarea>
                        </div>
                        <div class="row form-group">
                            <label for="content">内容：</label>
                            <textarea id="content" cols="60" rows="4" name="content" placeholder="请输入内容"></textarea>
                        </div>
                        <input type="hidden" name="creattime" value="<%=date%>" readonly="readonly"/>
                        <input type="hidden" name="creatby" value="${user.username}" readonly="readonly"/>
                        <div class="row form-group">
