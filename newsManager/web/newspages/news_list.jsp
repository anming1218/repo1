...
<div class="container">
    ...
    <div class="row">
        <div class="jumbotron">
            ...
            <div style="float: left;">
                ...
                <form class="form-inline" action="${pageContext.request.contextPath}/findNewsByPageServlet"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="topic" value="${condition.topic[0]}" class="form-control"
                               id="exampleInputName1">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputName2">标题</label>
                        <input type="text" name="title" value="${condition.title[0]}" class="form-control"
            ...
            <form id="form" action="${pageContext.request.contextPath}/delNewsSelectedServlet" method="post">
                <table border="1" class="table table-bordered table-hover">
                    ...
                    <c:forEach items="${pb.list}" var="news" varStatus="s">
                        <tr>
                            <td><input type="checkbox" name="nid" value="${news.id}"></td>
                            <td>${s.count}</td>
                            <td>${news.topic}</td>
                            <td>${news.title}</td>
                            <td>${news.author}</td>
                            ...
                            <td><a class="btn btn-default btn-sm"
                                   href="${pageContext.request.contextPath}/findNewsByIdServlet?id=${news.id}">修改</a>&nbsp;
                                <a class="btn btn-default btn-sm" href="javascript:deleteNews(${news.id});">删除</a></td>
                        </tr>
                    </c:forEach>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <li>
                            ...
                            <a href="${pageContext.request.contextPath}/findNewsByPageServlet?currentPage=${pb.currentPage - 1}&rows=10&topic=${condition.topic[0]}&title=${condition.title[0]}&author=${condiyion.author[0]}"
                               aria-label="Previous">
                        ...
                        <c:forEach begin="1" end="${pb.totalPage}" var="i">
                            ...
                            <c:if test="${pb.currentPage == i}">
                                <li class="active"><a
                                        href="${pageContext.request.contextPath}/findNewsByPageServlet?currentPage=${i}&rows=10&topic=${condition.topic[0]}&title=${condition.title[0]}&author=${condiyion.author[0]}">${i}</a>
                                </li>
                            </c:if>
                            <c:if test="${pb.currentPage != i}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/findNewsByPageServlet?currentPage=${i}&rows=10&topic=${condition.topic[0]}&title=${condition.title[0]}&author=${condiyion.author[0]}">${i}</a>
                                </li>
                            </c:if>
