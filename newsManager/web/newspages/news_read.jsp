        ...
        <div class="col-md-9">
            ...
            <div class="row">
                <div class="nmr fr center-block">
                    <div class="wz">
                        <span>您现在的位置：<a href="${pageContext.request.contextPath}/findNewsByPageToHomeServlet">首页</a>&nbsp;>&nbsp;<a>${news.topic}</a></span>
                    </div>
                    ...
                    <div class="nei n1">
                        <div class="con">
                            <h1>${news.title}</h1>
                            <div class="info">
                                发布时间：${news.creattime}&nbsp;&nbsp;修改时间：${news.modifytime}&nbsp;&nbsp;来源：${news.author}&nbsp;&nbsp;查看：${news.frequency}
                                &nbsp;&nbsp;次
                            </div>
                            <div>
