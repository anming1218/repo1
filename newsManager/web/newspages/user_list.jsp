                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <li>
                            ...
                            <a href="${pageContext.request.contextPath}/findUserByPageServlet?currentPage=${pb.currentPage - 1}&rows=10&username=${condition.username[0]}&age=${condition.age[0]}&email=${condition.email[0]}"
                               aria-label="Previous">
                        ...
                        <c:forEach begin="1" end="${pb.totalPage}" var="i">
                            ...
                            <c:if test="${pb.currentPage == i}">
                                <li class="active"><a
                                        href="${pageContext.request.contextPath}/findUserByPageServlet?currentPage=${i}&rows=10&username=${condition.username[0]}&age=${condition.age[0]}&email=${condition.email[0]}">${i}</a>
                                </li>
                            </c:if>
                            <c:if test="${pb.currentPage != i}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/findUserByPageServlet?currentPage=${i}&rows=10&username=${condition.username[0]}&age=${condition.age[0]}&email=${condition.email[0]}">${i}</a>
                                </li>
                            </c:if>
