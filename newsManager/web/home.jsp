...
<head>
    ...
    <!--导入本地css-->
    <link href="css/mynews.css" rel="stylesheet" type="text/css">
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="navbar-form navbar-left" action="${pageContext.request.contextPath}/loginServlet"
                  method="post">
                <label>登录名：</label>
                        ...
                        <div class="panel-footer col-md-12">
                            <ul class="list-group">
                                <a href="#" class="list-group-item  list-group-item-info">
                                    <h4 class="list-group-item-heading text-center" href="http://conferences.caixin.com/2020/caixinsummersummit2020/">2020财新夏季峰会~重启全球信心</h4>
                            ...
                            <div class="list-group side_list">
                                ...
                                <c:forEach items="${hotnews}" var="hotnews" varStatus="s">
                                    <a href="${pageContext.request.contextPath}/readNewsByIdServlet?id=${hotnews.id}"
                                       class="list-group-item" style="font-size: small;color: #0078B6">${s.count}.&nbsp;&nbsp;${hotnews.title}<img src="images/re.jpg" class="img-responsive pull-right"></a>
                                </c:forEach>
                            </div>
                        </div>
                    </div>
